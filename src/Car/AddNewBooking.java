...
public class AddNewBooking extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e){
      ...
      
        {
         ...
         int dayscout=Integer.parseInt(ch5.getSelectedItem());
         int carprice=dayscout*(Integer.parseInt(t9.getText()));
         String booking_status="Booked";
            ...
            try
            {
                ...
                String q="insert into car_booking values('"+bookind_id+"','"+username+"','"+name+"','"+phone+"','"+brandname+"','"+brandmodel+"','"+carno+"','"+carname+"','"+carsheet+"','"+carengine+"','"+carcategory+"','"+carmileage+"','"+carmirror+"','"+carprice+"','"+dayscout+"','"+dtf+"','"+booking_status+"')";
