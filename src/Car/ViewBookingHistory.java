...
public class ViewBookingHistory extends JFrame implements ActionListener
{
    ...
    String x[]={"Booking No","Customer Username","Brand Name","Brand Model","Car No","Car Name","Car Category","car mielage","Car Rent","Total Days","Booking Date","Status"};
    JButton b1;
     ...
     ViewBookingHistory() 
    {
        ...
        try
        {
            ...
            while(rest.next())
            {
                ...
                y[i][j++]=rest.getString("car_mielage");
             ...
             else
             {
                 try
                 {
                     ...
                     String q="update car_booking set booking_status='Cancel' where booking_id='"+booking_id+"'";
                       ...
                       {                       
                        JOptionPane.showMessageDialog(null, "Please fill the car number of booking id!");
                        String q1="update add_car set carstatus='Available' where carno='"+car_no+"'";
